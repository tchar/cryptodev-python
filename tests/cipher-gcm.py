...
tmp.key = cast(create_string_buffer(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'), POINTER(c_uint8))
tmp.auth = None
tmp.auth_size = 0
tmp.plaintext = cast(create_string_buffer(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'), POINTER(c_uint8))
tmp.plaintext_size = 16
tmp.ciphertext = cast(create_string_buffer(b'\x03\x88\xda\xce\x60\xb6\xa3\x92\xf3\x28\xc2\xb9\x71\xb2\xfe\x78'), POINTER(c_uint8))
tmp.iv = cast(create_string_buffer(b'\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00'), POINTER(c_uint8))
tmp.tag = cast(create_string_buffer(b'\xab\x6e\x47\xd4\x2c\xec\x13\xbd\xf5\x3a\x67\xb2\x12\x57\xbd\xdf'), POINTER(c_uint8))

aes_gcm_vectors[0] = tmp

tmp = aes_gcm_vectors_st()
tmp.key = cast(create_string_buffer(b'\xfe\xff\xe9\x92\x86\x65\x73\x1c\x6d\x6a\x8f\x94\x67\x30\x83\x08'), POINTER(c_uint8))
tmp.auth = None
tmp.auth_size = 0
tmp.plaintext = cast(create_string_buffer(b''), POINTER(c_uint8))
tmp.plaintext_size = 64
tmp.ciphertext = cast(create_string_buffer(b''), POINTER(c_uint8))
tmp.iv = cast(create_string_buffer(b'\xca\xfe\xba\xbe\xfa\xce\xdb\xad\xde\xca\xf8\x88'), POINTER(c_uint8))
tmp.tag = cast(create_string_buffer(b'\x4d\x5c\x2a\xf3\x27\xcd\x64\xa6\x2c\xf3\x5a\xbd\x2b\xa6\xfa\xb4'), POINTER(c_uint8))

aes_gcm_vectors[1] = tmp

tmp = aes_gcm_vectors_st()
tmp.key = cast(create_string_buffer(b'\xfe\xff\xe9\x92\x86\x65\x73\x1c\x6d\x6a\x8f\x94\x67\x30\x83\x08'), POINTER(c_uint8))
tmp.auth = cast(create_string_buffer(b'\xfe\xed\xfa\xce\xde\xad\xbe\xef\xfe\xed\xfa\xce\xde\xad\xbe\xef\xab\xad\xda\xd2'), POINTER(c_uint8))
tmp.auth_size = 20
tmp.plaintext = cast(create_string_buffer(b'\xd9\x31\x32\x25\xf8\x84\x06\xe5\xa5\x59\x09\xc5\xaf\xf5\x26\x9a\x86\xa7\xa9\x53\x15\x34\xf7\xda\x2e\x4c\x30\x3d\x8a\x31\x8a\x72\x1c\x3c\x0c\x95\x95\x68\x09\x53\x2f\xcf\x0e\x24\x49\xa6\xb5\x25\xb1\x6a\xed\xf5\xaa\x0d\xe6\x57\xba\x63\x7b\x39'), POINTER(c_uint8))
tmp.plaintext_size = 60
tmp.ciphertext = cast(create_string_buffer(b'\x42\x83\x1e\xc2\x21\x77\x74\x24\x4b\x72\x21\xb7\x84\xd0\xd4\x9c\xe3\xaa\x21\x2f\x2c\x02\xa4\xe0\x35\xc1\x7e\x23\x29\xac\xa1\x2e\x21\xd5\x14\xb2\x54\x66\x93\x1c\x7d\x8f\x6a\x5a\xac\x84\xaa\x05\x1b\xa3\x0b\x39\x6a\x0a\xac\x97\x3d\x58\xe0\x91'), POINTER(c_uint8))
tmp.iv = cast(create_string_buffer(b'\xca\xfe\xba\xbe\xfa\xce\xdb\xad\xde\xca\xf8\x88'), POINTER(c_uint8))
tmp.tag = cast(create_string_buffer(b'\x5b\xc9\x4f\xbc\x32\x21\xa5\xdb\x94\xfa\xe9\x5a\xe7\x12\x1a\x47'), POINTER(c_uint8))
...
def test_crypto(cfd):
    try:
        ...
        if debug:
            print('Tests on AES-GCM vectors: ', end='')

        for i in range(int(sizeof(aes_gcm_vectors) / sizeof(aes_gcm_vectors[0]))):
...
def test_encrypt_decrypt(cfd):
    try:
        ...
        if debug:
            print('Tests on AES-GCM encryption/decryption: ', end='')
...
def test_encrypt_decrypt_error(cfd, err):
    try:
        ...
        if debug:
            print('Tests on AES-GCM tag verification: ', end='')
        ...
        sess.mackeylen = 16
        sess.mackey = cast(create_string_buffer(b'\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b\x0b'), POINTER(c_uint8))
